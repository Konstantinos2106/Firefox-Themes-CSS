...
](https://addons.mozilla.org/en-US/firefox/user/19760903/)

Προσαρμοσμένα αρχεία CSS για Θέματα Firefox

Μπορείτε να βρείτε ολα τα θέματα Firefox εδω: https://addons.mozilla.org/el/firefox/user/19760903/
...
8. Στο φάκελο που άνοιξε κάνουμε επικόλληση του φακέλου chrome 
	Προσοχή μήπως ο φάκελος υπάρχει ήδη από προηγούμενη ενέργεια 
	α) Εάν ο φάκελος υπάρχει αλλά δεν υπάρχει αρχείο userChrome.css μέσα σε αυτόν, απλώς επικολλήστε το νέο αρχείο userChrome.css σε αυτόν τον φάκελο chrome
